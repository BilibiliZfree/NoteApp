...
namespace NoteApp.Api.Services
{
    public class NoteAppService : INoteAppService
    {
        ...
        public NoteAppService(NoteAppContext appContext)
        {
            _appContext = appContext;
        }

        public async Task<ApiResponse> DeleteResponse(int id)
        {
        ...
        public async Task<ApiResponse> GetResponse(int id)
        {
            var user = await _appContext.Users.FindAsync(id);
        ...
        public async Task<ApiResponse> GetsResponse()
        {
        ...
        public async Task<ApiResponse> PostResponse(UserEntity newUser)
        {
            if (newUser == null)
        ...
        public async Task<ApiResponse> PutResponse(UserEntity newUser)
        {
